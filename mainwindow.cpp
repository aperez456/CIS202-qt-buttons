    ...
    QMainWindow(parent)
{
    ...
    connect(button1,SIGNAL(clicked(bool)),this,SLOT(onbutton1Press(bool)));
    ...
    connect(button2,SIGNAL(clicked(bool)),this,SLOT(onbutton2Press(bool)));
    ...
    connect(button3,SIGNAL(clicked(bool)),this,SLOT(onbutton3Press(bool)));
}
